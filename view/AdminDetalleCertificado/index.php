...
<head>
    ...
    <title>CERTIPUCE::CERTIFICADO</title>
</head>
<body>

<?php
// Incluir menú y encabezado
        ...
        <div class="br-section-wrapper">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width:100%" name="cur_id" id="cur_id" data-placeholder="Seleccione">
                                ...
                                <!-- Aquí puedes cargar dinámicamente las opciones del select si es necesario -->
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-4">
            ...
            <div class="table-wrapper">
                <table id="detalle_data" class="table display responsive nowrap" width="100%">
                    ...
                    <tbody>
                        <!-- Aquí se mostrarán dinámicamente los datos según la interacción del usuario -->
                    </tbody>
                </table>
            </div>
